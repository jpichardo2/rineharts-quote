...
/** @type {string} */
const CACHE_VERSION = '1712287197|4231887911';
/** @type {string} */
const CACHE_PREFIX = 'Invisible Man-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'Invisible Man.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["Invisible Man.html","Invisible Man.js","Invisible Man.offline.html","Invisible Man.icon.png","Invisible Man.apple-touch-icon.png","Invisible Man.worker.js","Invisible Man.audio.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHABLE_FILES = ["Invisible Man.wasm","Invisible Man.pck"];
